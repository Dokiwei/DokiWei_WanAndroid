...
class MyBlurTransformation @JvmOverloads constructor(
    ...
    override val cacheKey = "${MyBlurTransformation::class.java.name}-$radius-$sampling"
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is MyBlurTransformation &&
